  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-[active]:bg-background data-[active]:text-foreground dark:data-[active]:border-input dark:data-[active]:bg-white/5 dark:data-[active]:text-foreground",
        "after:absolute after:bg-foreground after:opacity-0 after:transition-opacity group-data-[variant=line]/tabs-list:data-[active]:after:opacity-100 after:inset-x-0 after:bottom-[-5px] after:h-0.5",
        className
      )}
      {...props}
    />
